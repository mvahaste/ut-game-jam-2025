...
func _on_interactable_area_interact() -> void:
	...
	match _talk_count:
		1:
			DialogueManager.start_dialogue(DialogueManager.Dialogues.WISE_RAT_1)
		2:
			DialogueManager.start_dialogue(DialogueManager.Dialogues.WISE_RAT_2)
		3:
			DialogueManager.start_dialogue(DialogueManager.Dialogues.WISE_RAT_3)
		4:
			DialogueManager.start_dialogue(DialogueManager.Dialogues.WISE_RAT_4)
		_:
			return
